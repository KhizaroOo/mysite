...
// ===============================
(function() {
  // Only load GA4 on production (GitHub Pages)
  if (window.location.hostname === "khizarooo.github.io") {
    // Load gtag.js script
    const gtagScript = document.createElement('script');
    gtagScript.async = true;
    gtagScript.src = 'https://www.googletagmanager.com/gtag/js?id=GT-55BQQC8';
...
function Render_Footer(){
    "use strict";
    var footerHTML = `
        <div class="khizooo_tm_section border-top" id="socials" style="background: #ffffff;">
